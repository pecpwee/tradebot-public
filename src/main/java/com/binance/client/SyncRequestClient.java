...
public interface SyncRequestClient {
    ...
    Order postTestOrder(String symbol, OrderSide side, PositionSide positionSide, OrderType orderType,
                        TimeInForce timeInForce, String quantity, String price, String reduceOnly,
                        String newClientOrderId, String stopPrice, WorkingType workingType, NewOrderRespType newOrderRespType
            , String activationPrice, String callbackRate, boolean closePosition);
     ...
     */
    CountDownCancelResponse cancelAllOpenOrder(String symbol, Long countdownTime, Long timestamp);
