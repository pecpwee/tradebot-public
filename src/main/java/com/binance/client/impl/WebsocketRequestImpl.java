...
class WebsocketRequestImpl {
    ...
    com.binance.client.impl.WebsocketRequest<AggregateTradeEvent> subscribeAggregateTradeEvent(String symbol,
        ...
        com.binance.client.impl.WebsocketRequest<AggregateTradeEvent> request = new com.binance.client.impl.WebsocketRequest<>(subscriptionListener, errorHandler);
    ...
    com.binance.client.impl.WebsocketRequest<MarkPriceEvent> subscribeMarkPriceEvent(String symbol,
                                                                                     SubscriptionListener<MarkPriceEvent> subscriptionListener,
                                                                                     SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(symbol, "symbol")
                .shouldNotNull(subscriptionListener, "listener");
        com.binance.client.impl.WebsocketRequest<MarkPriceEvent> request = new com.binance.client.impl.WebsocketRequest<>(subscriptionListener, errorHandler);
    ...
    com.binance.client.impl.WebsocketRequest<CandlestickEvent> subscribeCandlestickEvent(String symbol, CandlestickInterval interval,
                                                                                         SubscriptionListener<CandlestickEvent> subscriptionListener,
                                                                                         SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(symbol, "symbol")
                .shouldNotNull(subscriptionListener, "listener");
        com.binance.client.impl.WebsocketRequest<CandlestickEvent> request = new com.binance.client.impl.WebsocketRequest<>(subscriptionListener, errorHandler);
    ...
    com.binance.client.impl.WebsocketRequest<SymbolMiniTickerEvent> subscribeSymbolMiniTickerEvent(String symbol,
                                                                                                   SubscriptionListener<SymbolMiniTickerEvent> subscriptionListener,
                                                                                                   SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(symbol, "symbol")
                .shouldNotNull(subscriptionListener, "listener");
        com.binance.client.impl.WebsocketRequest<SymbolMiniTickerEvent> request = new com.binance.client.impl.WebsocketRequest<>(subscriptionListener, errorHandler);
    ...
    com.binance.client.impl.WebsocketRequest<List<SymbolMiniTickerEvent>> subscribeAllMiniTickerEvent(
            SubscriptionListener<List<SymbolMiniTickerEvent>> subscriptionListener,
            SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(subscriptionListener, "listener");
        com.binance.client.impl.WebsocketRequest<List<SymbolMiniTickerEvent>> request = new com.binance.client.impl.WebsocketRequest<>(subscriptionListener, errorHandler);
    ...
    com.binance.client.impl.WebsocketRequest<SymbolTickerEvent> subscribeSymbolTickerEvent(String symbol,
                                                                                           SubscriptionListener<SymbolTickerEvent> subscriptionListener,
                                                                                           SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(symbol, "symbol")
                .shouldNotNull(subscriptionListener, "listener");
        com.binance.client.impl.WebsocketRequest<SymbolTickerEvent> request = new com.binance.client.impl.WebsocketRequest<>(subscriptionListener, errorHandler);
    ...
    com.binance.client.impl.WebsocketRequest<List<SymbolTickerEvent>> subscribeAllTickerEvent(
            SubscriptionListener<List<SymbolTickerEvent>> subscriptionListener,
            SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(subscriptionListener, "listener");
        com.binance.client.impl.WebsocketRequest<List<SymbolTickerEvent>> request = new com.binance.client.impl.WebsocketRequest<>(subscriptionListener, errorHandler);
    ...
    com.binance.client.impl.WebsocketRequest<SymbolBookTickerEvent> subscribeSymbolBookTickerEvent(String symbol,
                                                                                                   SubscriptionListener<SymbolBookTickerEvent> subscriptionListener,
                                                                                                   SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(symbol, "symbol")
                .shouldNotNull(subscriptionListener, "listener");
        com.binance.client.impl.WebsocketRequest<SymbolBookTickerEvent> request = new com.binance.client.impl.WebsocketRequest<>(subscriptionListener, errorHandler);
    ...
    com.binance.client.impl.WebsocketRequest<SymbolBookTickerEvent> subscribeAllBookTickerEvent(
            SubscriptionListener<SymbolBookTickerEvent> subscriptionListener,
            SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(subscriptionListener, "listener");
    ...
    com.binance.client.impl.WebsocketRequest<LiquidationOrderEvent> subscribeSymbolTradeEvent(String symbol,
                                                                                                         SubscriptionListener<LiquidationOrderEvent> subscriptionListener,
                                                                                                         SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(symbol, "symbol")
                .shouldNotNull(subscriptionListener, "listener");
        com.binance.client.impl.WebsocketRequest<LiquidationOrderEvent> request = new com.binance.client.impl.WebsocketRequest<>(subscriptionListener, errorHandler);
    ...
    com.binance.client.impl.WebsocketRequest<LiquidationOrderEvent> subscribeSymbolLiquidationOrderEvent(String symbol,
                                                                                                         SubscriptionListener<LiquidationOrderEvent> subscriptionListener,
                                                                                                         SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(symbol, "symbol")
    ...
    com.binance.client.impl.WebsocketRequest<LiquidationOrderEvent> subscribeAllLiquidationOrderEvent(
            SubscriptionListener<LiquidationOrderEvent> subscriptionListener,
            SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(subscriptionListener, "listener");
    ...
    com.binance.client.impl.WebsocketRequest<OrderBookEvent> subscribeBookDepthEvent(String symbol, Integer limit,
        ...
        com.binance.client.impl.InputChecker.checker()
                ...
                .shouldNotNull(subscriptionListener, "listener");
        com.binance.client.impl.WebsocketRequest<OrderBookEvent> request = new com.binance.client.impl.WebsocketRequest<>(subscriptionListener, errorHandler);
    ...
    com.binance.client.impl.WebsocketRequest<OrderBookEvent> subscribeDiffDepthEvent(String symbol,
                                                                                     SubscriptionListener<OrderBookEvent> subscriptionListener,
                                                                                     SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(symbol, "symbol")
    ...
    com.binance.client.impl.WebsocketRequest<UserDataUpdateEvent> subscribeUserDataEvent(String listenKey,
                                                                                         SubscriptionListener<UserDataUpdateEvent> subscriptionListener,
                                                                                         SubscriptionErrorHandler errorHandler) {
        com.binance.client.impl.InputChecker.checker()
                .shouldNotNull(listenKey, "listenKey")
                .shouldNotNull(subscriptionListener, "listener");
        com.binance.client.impl.WebsocketRequest<UserDataUpdateEvent> request = new com.binance.client.impl.WebsocketRequest<>(subscriptionListener, errorHandler);
