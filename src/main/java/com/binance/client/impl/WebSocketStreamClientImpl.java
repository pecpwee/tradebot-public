...
public class WebSocketStreamClientImpl implements SubscriptionClient {
    ...
    private <T> void createConnection(com.binance.client.impl.WebsocketRequest<T> request, boolean autoClose) {
        if (watchDog == null) {
    ...
    private <T> void createConnection(com.binance.client.impl.WebsocketRequest<T> request) {
